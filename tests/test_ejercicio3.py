...
def test_comparar_menor():
    '''
    Comprueba la funcion en el caso de que el primer numero sea menor
    que el segundo
    '''
    nro1=3
    nro2=5
...
def test_comparar_mayor():
    '''
    Comprueba la funcion en el caso de que el primer numero sea mayor
    que el segundo
    '''
    nro1=6
    nro2=5
...
def test_comparar_igual():
    '''
    Comprueba la funcion en el caso de que el primer numero sea igual
    que el segundo
    '''
    nro1=3
    nro2=3
